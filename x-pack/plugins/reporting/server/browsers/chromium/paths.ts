...
export const chromiumCommit = 'ef768c9'; // TODO: test to ensure this matches the full commit hash in x-pack/build_chromium/.chromium-commit
const fileBase = 'chromium-' + chromiumCommit;
  ...
  packages: [
    {
      ...
      architecture: 'x64',
      archiveFilename: fileBase + '-darwin_x64.zip',
    ...
    },
    {
      platforms: ['linux'],
      architecture: 'x64',
      archiveFilename: fileBase + '-linux_x64.zip',
    ...
    },
    {
      platforms: ['linux'],
      architecture: 'arm64',
      archiveFilename: fileBase + '-linux_arm64.zip',
    ...
    },
    {
      platforms: ['win32'],
      architecture: 'x64',
      archiveFilename: fileBase + '-windows_x64.zip',
